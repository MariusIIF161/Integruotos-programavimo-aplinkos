...
namespace integruotos_programavimo_aplinkos
{
    class StudentasController
    {
        ...
        public List<Studentas> geri;
        public List<Studentas> blogi;

        public StudentasController() {
            sarasas = new List<Studentas>();
            geri = new List<Studentas>();
            blogi = new List<Studentas>();
        ...
        public void skirstymas()
        {
            ...
            {
                if(this.sarasas[x].getEgzaminas() * 0.7 + 0.3 * this.vidurkis("Vid", this.sarasas[x].getND()) < 5)
                {
                    blogi.Add(this.sarasas[x]);
                    sarasas.Remove(this.sarasas[x]);
                    x--;
                }
            }
        }

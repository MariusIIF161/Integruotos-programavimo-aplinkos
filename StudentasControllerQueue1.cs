...
namespace integruotos_programavimo_aplinkos
{
    ...
    {
        public Queue<Studentas> sarasas;
        public Queue<Studentas> geri;
        public Queue<Studentas> blogi;

        public StudentasController() {
            sarasas = new Queue<Studentas>();
            geri = new Queue<Studentas>();
            blogi = new Queue<Studentas>();
        ...
        {
            this.sarasas.Enqueue(new Studentas());
        }
            ...
            try
            {
                ...
                foreach(String line in lines)
                {
                    ...
                    if(!firstLine)
                    {
                        ...
                        this.sarasas.Enqueue(new Studentas(words[0], words[1]));
        ...
        public void skirstymas()
        {
            for(int x = 0; x < this.sarasas.Count; x++)
            {
                ...
                {
                    blogi.Enqueue(this.sarasas.ElementAt(x));
                    sarasas = new Queue<Studentas>(sarasas.Where(s => s != this.sarasas.ElementAt(x)));
                    x--;
                }
            }
        }
